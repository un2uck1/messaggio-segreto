...
const PUZZLES = [
  // ── Proverbi ──
  { category:"Proverbio",    phrase:"CHI DORME NON PIGLIA PESCI" },
  { category:"Proverbio",    phrase:"MEGLIO TARDI CHE MAI" },
  { category:"Proverbio",    phrase:"LA FORTUNA AIUTA GLI AUDACI" },
  { category:"Proverbio",    phrase:"CHI CERCA TROVA" },
  { category:"Proverbio",    phrase:"CAN CHE ABBAIA NON MORDE" },
  { category:"Proverbio",    phrase:"PAESE CHE VAI USANZA CHE TROVI" },
  ...
  { category:"Proverbio",    phrase:"CHI LA FA L ASPETTI" },
  { category:"Proverbio",    phrase:"RIDE BENE CHI RIDE ULTIMO" },
  { category:"Proverbio",    phrase:"IL TEMPO E DENARO" },
  { category:"Proverbio",    phrase:"TROPPI CUOCHI GUASTANO LA MINESTRA" },
  { category:"Proverbio",    phrase:"OGNI LASCIATA E PERSA" },
  { category:"Proverbio",    phrase:"NON SI PUO AVERE LA BOTTE PIENA E LA MOGLIE UBRIACA" },
  // ── Cinema ──
  { category:"Cinema",       phrase:"CHE LA FORZA SIA CON TE" },
  { category:"Cinema",       phrase:"LA VITA E BELLA" },
  { category:"Cinema",       phrase:"IO STO BENE" },
  { category:"Cinema",       phrase:"UN AMERICANO A ROMA" },
  { category:"Cinema",       phrase:"IL BUONO IL BRUTTO E IL CATTIVO" },
  { category:"Cinema",       phrase:"CINEMA PARADISO" },
  { category:"Cinema",       phrase:"AMARCORD" },
  { category:"Cinema",       phrase:"IL POSTINO" },
  { category:"Cinema",       phrase:"NUOVO CINEMA PARADISO" },
  { category:"Cinema",       phrase:"BENVENUTI AL SUD" },
  { category:"Cinema",       phrase:"PERFETTI SCONOSCIUTI" },
  { category:"Cinema",       phrase:"IL GRANDE LEBOWSKI" },
  { category:"Cinema",       phrase:"NESSUN DORMA" },
  // ── Musica italiana ──
  { category:"Musica",       phrase:"CON TE PARTIRO" },
  { category:"Musica",       phrase:"VOLARE NEL BLU DIPINTO DI BLU" },
  { category:"Musica",       phrase:"NEL BLU DIPINTO DI BLU" },
  { category:"Musica",       phrase:"AZZURRO IL POMERIGGIO E TROPPO AZZURRO" },
  { category:"Musica",       phrase:"SENZA RITMO NON SI BALLA" },
  { category:"Musica",       phrase:"UNA CANZONE CAMBIA LA GIORNATA" },
  { category:"Musica",       phrase:"OGNI CORO HA UNA VOCE NASCOSTA" },
  { category:"Musica",       phrase:"LA MUSICA E IL CIBO DELL ANIMA" },
  { category:"Musica",       phrase:"FELICITA E STARE INSIEME" },
  { category:"Musica",       phrase:"ROMAGNA MIA" },
  { category:"Musica",       phrase:"GLORIA" },
  { category:"Musica",       phrase:"FIGLI DELLE STELLE" },
  // ── Modi di dire ──
  { category:"Modo di dire", phrase:"UN PASSO ALLA VOLTA" },
  { category:"Modo di dire", phrase:"TRA IL DIRE E IL FARE C E IL MARE" },
  { category:"Modo di dire", phrase:"AVERE IL CUORE IN GOLA" },
  { category:"Modo di dire", phrase:"PRENDERE DUE PICCIONI CON UNA FAVA" },
  { category:"Modo di dire", phrase:"ACQUA IN BOCCA" },
  { category:"Modo di dire", phrase:"CAVARSELA PER UN PELO" },
  { category:"Modo di dire", phrase:"AVERE LE MANI IN PASTA" },
  { category:"Modo di dire", phrase:"FARE ORECCHIE DA MERCANTE" },
  { category:"Modo di dire", phrase:"IN BOCCA AL LUPO" },
  { category:"Modo di dire", phrase:"NON AVERE PELI SULLA LINGUA" },
  { category:"Modo di dire", phrase:"DORMIRE SUGLI ALLORI" },
  { category:"Modo di dire", phrase:"PERDERE LA TESTA" },
  { category:"Modo di dire", phrase:"AVERE IL PROSCIUTTO SUGLI OCCHI" },
  // ── Sport ──
  { category:"Sport",        phrase:"SQUADRA CHE VINCE NON SI CAMBIA" },
  { category:"Sport",        phrase:"FINO AL FISCHIO FINALE SI GIOCA" },
  { category:"Sport",        phrase:"IL TALENTO SI ALLENA OGNI GIORNO" },
  { category:"Sport",        phrase:"FORZA E CORAGGIO" },
  { category:"Sport",        phrase:"LO SPORT E UNA SCUOLA DI VITA" },
  { category:"Sport",        phrase:"VINCI COME UNA SQUADRA" },
  { category:"Sport",        phrase:"CAMPIONI SI DIVENTA" },
  { category:"Sport",        phrase:"IL CALCIO E LA POESIA DEI POVERI" },
  // ── Cibo e cucina ──
  { category:"Cibo",         phrase:"LA PIZZA METTE TUTTI D ACCORDO" },
  { category:"Cibo",         phrase:"UN BUON PROFUMO PORTA TUTTI IN CUCINA" },
  { category:"Cibo",         phrase:"A TAVOLA NASCONO GRANDI IDEE" },
  { category:"Cibo",         phrase:"IL CIBO E AMORE" },
  { category:"Cibo",         phrase:"LA PASTA UNISCE L ITALIA" },
  { category:"Cibo",         phrase:"MANGIA BENE RIDI SPESSO AMA TANTO" },
  { category:"Cibo",         phrase:"IL VINO E LA POESIA DELLA TERRA" },
  { category:"Cibo",         phrase:"LA COLAZIONE E IL PASTO PIU IMPORTANTE" },
  { category:"Cibo",         phrase:"PANE OLIO E SALE" },
  { category:"Cibo",         phrase:"IL SUGO DEVE CUOCERE PIANO" },
  // ── Natura e viaggi ──
  { category:"Natura",       phrase:"DOPO LA PIOGGIA TORNA IL SOLE" },
  { category:"Natura",       phrase:"ANCHE IL MARE COMINCIA DA UNA GOCCIA" },
  { category:"Natura",       phrase:"IL CIELO SOPRA ROMA" },
  { category:"Natura",       phrase:"LA MONTAGNA CHIAMA" },
  { category:"Natura",       phrase:"IL SILENZIO DEL BOSCO" },
  { category:"Natura",       phrase:"IL MARE DI NOTTE HA UN ALTRO SUONO" },
  { category:"Viaggio",      phrase:"OGNI VIAGGIO INIZIA CON UN PASSO" },
  { category:"Viaggio",      phrase:"LE MAPPE NON RACCONTANO TUTTO" },
  { category:"Viaggio",      phrase:"LA STRADA MIGLIORE NON E SEMPRE DRITTA" },
  { category:"Viaggio",      phrase:"VIAGGIARE APRE LA MENTE" },
  { category:"Viaggio",      phrase:"IL TRENO PER PARIGI" },
  { category:"Viaggio",      phrase:"ROMA NON FU COSTRUITA IN UN GIORNO" },
  // ── Vita e pensieri ──
  { category:"Vita",         phrase:"IL TEMPO E UN GRANDE MAESTRO" },
  { category:"Vita",         phrase:"SBAGLIANDO SI IMPARA DAVVERO" },
  { category:"Vita",         phrase:"LA LUCE ACCESA FA COMPAGNIA" },
  { category:"Vita",         phrase:"OGNI PORTA HA LA SUA CHIAVE" },
  { category:"Vita",         phrase:"LE PAROLE TROVANO SEMPRE STRADA" },
  { category:"Vita",         phrase:"IL SEGRETO E SOTTO GLI OCCHI" },
  { category:"Vita",         phrase:"OGNI INDIZIO HA IL SUO MOMENTO" },
  { category:"Vita",         phrase:"LA RISPOSTA AMA I DETTAGLI" },
  { category:"Vita",         phrase:"UNA STORIA PUO APRIRE MONDI" },
  { category:"Vita",         phrase:"LE IDEE SI ACCENDONO IN RETE" },
  { category:"Vita",         phrase:"IL CORAGGIO DI RICOMINCIARE" },
  { category:"Vita",         phrase:"NESSUN POSTO E COME CASA" },
  { category:"Vita",         phrase:"LE PICCOLE COSE FANNO LA DIFFERENZA" },
  { category:"Vita",         phrase:"DOMANI E UN ALTRO GIORNO" },
  { category:"Vita",         phrase:"LA SEMPLICITA E LA FORMA SUPREMA DELLA RAFFINATEZZA" },
  // ── Mistero e gioco ──
  { category:"Mistero",      phrase:"IL SEGRETO DEL GIORNO" },
  { category:"Mistero",      phrase:"LA MOSSA GIUSTA ARRIVA ALLA FINE" },
  { category:"Mistero",      phrase:"UN BUG NASCONDE UNA SCOPERTA" },
  { category:"Gioco",        phrase:"CHI GIOCA BENE VINCE SEMPRE" },
  { category:"Gioco",        phrase:"IL GIOCO E UNA COSA SERIA" },
  { category:"Gioco",        phrase:"VINCE CHI HA PIU PAZIENZA" },
  // ── Citazioni ──
  { category:"Citazione",    phrase:"ESSERE O NON ESSERE" },
  { category:"Citazione",    phrase:"COGITO ERGO SUM" },
  { category:"Citazione",    phrase:"ANCHE LE STELLE HANNO UN NOME" },
  { category:"Citazione",    phrase:"LA FANTASIA E PIU IMPORTANTE DELLA CONOSCENZA" },
  { category:"Citazione",    phrase:"IL DUBBIO E L INIZIO DELLA SAGGEZZA" },
  { category:"Citazione",    phrase:"OGNUNO VEDE CIO CHE SA" },
  { category:"Citazione",    phrase:"LA LIBERTA E SCEGLIERE" },
  { category:"Citazione",    phrase:"AMA IL PROSSIMO TUO COME TE STESSO" },
  { category:"Citazione",    phrase:"NON RIMANDARE A DOMANI" },
  { category:"Citazione",    phrase:"IL FUTURO HA GIA COMINCIATO" },
];
